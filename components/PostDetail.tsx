...
import { PostProps, ContentFragment } from "../types/interfaces";
...
const PostDetail:FC<PostProps> = ({ post }) => {
  const getContentFragment = (index: number, text: any, obj: any, type?: string) => {
    ...
    } else if(typeof modifiedText === "string") {
      return modifiedText
    } else {
      if (obj) {
          if (obj.bold) {
      ...
      <div className="px-4 lg:px-0">
        <div className="flex items-center mb-8 w-full">
          <div className="flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8">
            ...
            />
            <p className="inline align-middle text-gray-700 ml-2 text-lg dark:text-white">
              {post.author.name}
            </p>
          </div>
